...
%   Load video information    
    video_path_UAV123 = '.\OTB100\sequences';
%     video_path_UAV123 = 'F:/跟踪/OTB100/sequences';
%     ground_truth_path_UAV123 = 'F:/KCF实验结果次数/第十四次重新搭建/tracker_benchmark_v1.0/anno';
    ground_truth_path_UAV123 = '.\OTB100\anno';
    ...
    results       = run_OMFL1(seq, video_path, learning_rate);
