...
function results = run_OMFL1(seq, video_path, lr)
...
%   params.ground_truth_bacf = seq.ground_truth_bacf;
%    params.ground_truth_kcf = seq.ground_truth_kcf;
% params.ground_truth_ldes = seq.ground_truth_ldes;
